...
export default class DeskView extends React.Component {
    constructor(props) {
        super(props)
        this.state = {
            isLoading: false,
    ...
    navigateToMore = () => {
        ...
        this.props.callBackForMoreTabInDeskView(ConstantValues.MORE_STR);
    }
    componentDidMount() {
    ...
    renderRowVocherDetails() {
        return <VocherDetailsView
            ...
            callBackForMoreTabInVocherDetailsView={this.props.callBackForMoreTabInDeskView}
        />
    }
