...
import SellingEnable from '../../../../assets/svg/Selling_enable.svg';
import { SvgXml } from "react-native-svg";
import ProgressIndicatorView from "../card_view/ProgressIndicatorView";
const SellingAnalysisView = ({ onBack, onNext }) => {
    return (
        <View style={{
            flex: 1,
                ...
                <View style={{
                    ...
                    <View style={{
                        ...
                        <View style={{
                            ...
                            <SvgXml xml={SellingEnable} height="50" width="50" />
                            <Text style={{
                                fontSize: 13,
                                marginVertical: 5,
                                marginHorizontal: 10,
                    ...
                    <Text style={{
                        ...
                        fontFamily: (Platform.OS === 'ios') ? "Gilroy-SemiBold" : "Radomir Tinkov - Gilroy-SemiBold",
                    }}>Vouchers: Sell data in the form of a printed slip Direct top-up: Sending the data directly to the customer’s number</Text>
                </View>
...
export default SellingAnalysisView;