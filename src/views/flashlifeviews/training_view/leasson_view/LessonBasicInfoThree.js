...
const LessonBasicInfoThree = ({ props, onNext, onBack,onItemData }) => {
    const[itemBody,setItemBody]=useState()

    // const body=onItemData.lessonSteps[2].lessonStepItemGroups[0].lessonStepItemGroupItems[0]
...
getItemdata()
    ...
    const getItemdata=()=>{
        ...
        const data=onItemData.lessonSteps[2].lessonStepItemGroups
        let itembody=[];
    ...
    return (
        <View style={{
            ...
            <View style={{
                ...
                }}>{onItemData.lessonSteps[2].title}</Text>
            ...
            <ProgressIndicatorView style={{
                ...
                progressbarColor={'#B8B8B8'}
                    ...
                    earnedPoints={onItemData.lessonSteps[2].stepNumber}
...
export default LessonBasicInfoThree;
