...
export default class FlashWeblinkView extends React.Component {
    constructor(props) {
        super(props)
        this.state = {
    ...
    navigateToMore = () => {
        ...
        this.props.callBackForMoreTabInFlasWebLinkview(ConstantValues.MORE_STR);
    }
