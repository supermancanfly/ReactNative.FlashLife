...
export const subscribeChannels = (userID, callback) => {
  ...
  // console.log("subscribeChannels---------------------chat_feed-----------------------------------------------")
...
export const hydrateSocialChatFeedItem = async (
  ...
  // console.log("hydrateSocialChatFeedItem")
...
export const createChannel = (creator, otherParticipants, name) => {
  // console.log("createChannel"+JSON.stringify(creator)+"otherParticipants"+JSON.stringify(otherParticipants)+"name"+name)
  return new Promise((resolve) => {
