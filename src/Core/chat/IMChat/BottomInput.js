...
async function checkMultiPermissions() {
  // console.log("checkMultiPermissions")
  ...
  if (status !== 'granted') {
   ...
   const status= getAudioPermissionsAsync() 
...
async function getAudioPermissionsAsync() {
  // permissions returns only for location permissions on iOS and under certain conditions, see Permissions.LOCATION
  const { status, permissions } = await Permissions.getAsync(Permissions.AUDIO_RECORDING);
